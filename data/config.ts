...
export const siteConfig: SiteConfig = {
  name: 'Labell - Натяжні стелі в Києві',
  description: 'Преміум натяжні стелі від Labell. Понад 16 років досвіду. Глянцеві, матові, фотодрук, парящі стелі. Швидка установка, гарантія, доставка по всій Україні.',
